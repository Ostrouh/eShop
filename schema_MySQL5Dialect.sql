...
create table CREDENTIAL (id integer not null auto_increment, CREATED_AT datetime not null, MODIFIED_AT datetime, EMAIL varchar(64) not null, IS_IN_BLACK_LIST bit not null, LOGIN varchar(255) not null, PASSWORD varchar(255) not null, ROLE varchar(255) not null, primary key (id)) engine=MyISAM;
create table ORDER_PRODUCT (ORDER_ID integer not null, PRODUCT_ID integer not null) engine=MyISAM;
create table ORDERS (id integer not null auto_increment, CREATED_AT datetime not null, MODIFIED_AT datetime, STATUS varchar(255) not null, USER_ID integer, primary key (id)) engine=MyISAM;
