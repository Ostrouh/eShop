...
insert into CART
  (CREATED_AT, MODIFIED_AT, USER_ID, TOTAL_COST, ITEMS_AMOUNT)
values (timestamp(now()), timestamp(now()), 1, 0, 0);
...
insert into CART
  (CREATED_AT, MODIFIED_AT, USER_ID, TOTAL_COST, ITEMS_AMOUNT)
values (timestamp(now()), timestamp(now()), 2, 0, 0);
...
insert into CART
  (CREATED_AT, MODIFIED_AT, USER_ID, TOTAL_COST, ITEMS_AMOUNT)
values (timestamp(now()), timestamp(now()), 3, 0, 0);
